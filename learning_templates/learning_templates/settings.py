...
TEMPLATE_TAG_DIR = os.path.join(BASE_DIR, 'basic_app.templatetags')

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/1.11/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'nmvpg$y_f%(fk#n_98e0m_s5scv-%6%_g7kms6%+^0z=(z78u)'
...
TEMPLATES = [
    {
        ...
        'DIRS': [TEMPLATE_DIR,TEMPLATE_TAG_DIR,],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
